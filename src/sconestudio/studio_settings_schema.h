...
viewer {
	...
	max_shadow_dist { type = float label = "Maximum distance from the focus point at which shadows are renderd" default = 10 }
	...
	ligament_100 { type = color label = "Ligament color under tension" default = "hsv(0, 80, 100)" }
...
muscle_analysis {
	...
	muscle_detail { type = bool default = 0 label = "Show unnormalized muscle data" }
	ligament_detail { type = bool default = 1 label = "Show unnormalized ligament data" }
}
